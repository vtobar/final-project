...
urlpatterns = [
    ...
    url(r'^display_pic_data2', views.display_pic_data1, name= "display_pic_data2"),
    url(r'^display_pic_data2/(?P<year>[0-9]+)/$', views.display_pic_data1, name= "display_pic_data2"),
    url(r'^plot_data2/$', views.plot_data1, name= "plot_data2"),
    url(r'^plot_data2/(?P<year>[0-9]+)/$', views.plot_data1, name= "plot_data2"),
